          ...
          >
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="cta-company" className="block text-xs font-bold text-[#102033]">
                  ...
                  <div>
                    <label htmlFor="cta-interest" className="block text-xs font-bold text-[#102033]">
                ...
                <div>
                  <label htmlFor="cta-objectives" className="block text-xs font-bold text-[#102033]">
