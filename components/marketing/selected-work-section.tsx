  ...
  return (
    <section id="selected-work" className="bg-[#FFFFFF] text-[#122D2E] py-16 sm:py-20 lg:py-24 border-b border-[#C9DDD7]">
      <div className="mx-auto max-w-[1440px] px-6 lg:px-8 xl:px-10">
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end pb-8 border-b border-[#C9DDD7]">
          <div>
            ...
            <h2 className="mt-3 font-serif text-3xl sm:text-4xl lg:text-[42px] font-semibold tracking-[-0.03em] text-[#122D2E] leading-tight">
              ...
              <br />
              <span className="text-[#0B4A47]">Creating lasting value.</span>
            </h2>
          </div>
        ...
        {/* Featured Case Study with Shaped Image Composition */}
        <motion.article
          initial={shouldReduceMotion ? {} : { opacity: 0, y: 16 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.55 }}
          className="mt-10 overflow-hidden rounded-[14px] border border-[#C9DDD7] bg-white ca-shadow-elevated"
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 items-stretch">
            {/* Left 55%: Contextual Photograph with Asymmetric Arch */}
            <div className="relative aspect-[16/10] lg:aspect-auto lg:col-span-7 overflow-hidden bg-[#073B3A] p-2">
              <div className="relative w-full h-full min-h-[300px] overflow-hidden rounded-[10px] lg:rounded-[12px_80px_12px_12px]">
                <Image
            ...
            <div className="p-8 lg:p-10 lg:col-span-5 flex flex-col justify-between space-y-6">
              <div>
                ...
                <h3 className="mt-2.5 font-serif text-xl sm:text-2xl font-bold text-[#122D2E] leading-snug">
                  {featuredCase.title}
                </h3>

                <div className="mt-6 space-y-3.5 text-xs sm:text-sm leading-relaxed">
                  <div>
                    <strong className="text-[#122D2E]">Challenge:</strong>{" "}
                    <span className="text-[#5B6D6B]">{featuredCase.challenge}</span>
                  </div>
                  <div>
                    <strong className="text-[#122D2E]">Approach:</strong>{" "}
                    <span className="text-[#5B6D6B]">{featuredCase.approach}</span>
                  </div>
                  <div>
                    <strong className="text-[#122D2E]">Outcome:</strong>{" "}
                    <span className="text-[#5B6D6B]">{featuredCase.outcome}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-[#C9DDD7]">
                <Link
                  ...
                  className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#B83A3A] hover:text-[#992F31] transition-colors"
                >
        ...
        {/* 2 Secondary Case-Study Modules with Shaped Photography */}
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          {secondaryCases.map((cs, idx) => (
            <motion.article
              ...
              className="group flex flex-col rounded-[14px] border border-[#C9DDD7] bg-white overflow-hidden shadow-2xs hover:border-[#0B4A47]/40 transition-all duration-300"
            >
              <div className="p-2 pb-0">
                <div className={`relative aspect-[16/9] w-full bg-[#073B3A] overflow-hidden ${cs.imageShape}`}>
                  <Image
                    src={cs.image}
                    alt={cs.headline}
                    fill
                    className="object-cover mkt-img-graded transition-transform duration-600 group-hover:scale-103"
              ...
              <div className="p-7 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="rounded bg-[#E1ECE8] px-2 py-0.5 text-[0.62rem] font-bold text-[#0B4A47]">
                      {cs.tag}
                    </span>
                  </div>

                  <h3 className="mt-3 font-serif text-lg sm:text-xl font-bold text-[#122D2E] group-hover:text-[#0B4A47] transition-colors leading-snug">
                    {cs.headline}
                  </h3>
                  ...
                  <div className="mt-4 space-y-2 text-xs leading-relaxed">
                    <div>
                      <strong className="text-[#122D2E]">Challenge:</strong>{" "}
                      <span className="text-[#5B6D6B]">{cs.challenge}</span>
                    </div>
                    <div>
                      <strong className="text-[#122D2E]">Approach:</strong>{" "}
                      <span className="text-[#5B6D6B]">{cs.approach}</span>
                    </div>
                  </div>
                </div>

                <div className="pt-3 border-t border-[#C9DDD7]">
                  <Link
                    href={cs.linkHref}
                    className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#B83A3A] hover:text-[#992F31] transition-colors"
                  >
