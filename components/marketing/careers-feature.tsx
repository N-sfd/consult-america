...
export default function CareersFeature() {
  ...
  return (
    <section id="careers-preview" className="bg-[#FFFFFF] text-[#102033] py-16 sm:py-20 lg:py-24 border-b border-[#DCE3E5]">
      <div className="mx-auto max-w-[1440px] px-6 lg:px-8 xl:px-10">
        <div className="overflow-hidden rounded-[10px] border border-[#DCE3E5] bg-[#EDF5F3] shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-12 items-stretch">
            ...
            <motion.div
              ...
              className="relative aspect-[4/3] sm:aspect-[16/10] lg:aspect-auto lg:col-span-6 overflow-hidden bg-[#0B1F2D]"
            >
              <Image
            ...
            {/* RIGHT: Content on Soft Teal Surface */}
            <motion.div
              initial={shouldReduceMotion ? {} : { opacity: 0, x: 16 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.55 }}
              className="p-8 sm:p-12 lg:p-16 lg:col-span-6 bg-[#EDF5F3] text-[#102033] flex flex-col justify-between space-y-6"
            >
              <div>
                ...
                <h3 className="mt-4 font-serif text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-[-0.03em] text-[#102033] leading-[1.08]">
                  Build what&apos;s next.
                </h3>

                <p className="mt-4 text-base sm:text-lg leading-relaxed text-[#5A6770]">
                  Work at the intersection of enterprise transformation, AI, data and application engineering.
                </p>
              </div>

              <div className="pt-6 border-t border-[#DCE3E5]">
                <Link
                  href="/careers"
